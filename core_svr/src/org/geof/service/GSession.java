...
public class GSession implements Comparable<GSession> {
	...
	protected long _createTimestamp = 0;
	protected long _lastAccessed = 0;
	protected long _maxTimeout = 1200000;
	
	protected HashMap<String, String> _data = new HashMap<String, String>();
	protected List<Integer> _ugroups = new ArrayList<Integer>();
	protected SecretKeySpec _aesKeySpec = null;
	protected List<String> _tokens = new ArrayList<String>();
	
	public GSession(String key, long usrid) {
		this(key,usrid,null);
	}
	...
	public List<Integer> getUGroups() {
		return _ugroups;
	}
	...
	public void printValues() {
		for (String key : _data.keySet()) {
			GLogger.debug("--- key " + key + ", value " + _data.get(key));
		}
		// GLogger.debug("Permissions: " + Arrays.toString(Permissions));
	}
